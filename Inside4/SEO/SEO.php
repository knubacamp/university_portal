...
Class SEO
{
    ...
    var $seo_data = Array(
        Array(
            'page_url' => '/',
            'seo_title' => 'KNUBA Portal',
            'seo_description' => 'University Education System',
            'seo_keywords' => '',
        ),
        Array(
            'page_url' => '/ua/',
            'seo_title' => 'KNUBA Портал',
            'seo_description' => 'Система для університету',
            'seo_keywords' => '',
        ),
        Array(
            'page_url' => '/ru/',
            'seo_title' => 'KNUBA Портал',
            'seo_description' => 'Система для университета',
            'seo_keywords' => '',
        ),
        Array(
            'page_url' => '/auth/login',
